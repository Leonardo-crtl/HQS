<?php
  ...
  if ( !isset ( $id ) ) $id = "";
  $nome = $cpf = $datanascimento = $email = $senha = $cep = $endereco = $complemento = 
    $bairro = $cidade_id = $foto = $telefone = $celular = $nome_cidade = $estado = "";
		...
		<div class="row">
			<div class="col-12 col-md-2">
			 ...
			 <div class="col-12 col-md-4">
			 	...
			 	<input type="text" name="datanascimento" id="datanascimento" class="form-control" required data-parsley-required-message="Preencha a data de nacimento" placeholder="Digite a data de nacimento 11/12/1990" value="<?=$datanascimento;?>">
			 </div>
			...
			<div class="col-12 col-md-6">
			 ...
			 <div class="col-12">
			 	...
			 	<input type="email" name="email" id="email" class="form-control" required data-parsley-required-message="Preencha o e-mail" data-parsley-type-message="Digite um e-mail válido" value="<?=$email;?>">
			 </div>
			 ...
			 <div class="col-12 col-md-2">
			 	...
			 	<input type="text" name="cep" id="cep" class="form-control" required data-parsley-required-message="Preencha seu CEP" value="<?=$cep;?>">
			 </div>
