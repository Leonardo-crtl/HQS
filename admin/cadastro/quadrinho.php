<?php
  ...
  if ( !empty ( $id ) ) {
  	$sql = "select *, date_format(data, '%d/%m/%Y') dt
  		from quadrinho where id = :id limit 1";
...
<div class="container">
	...
	<div class="col-12 col-md-2" >
		...
		required data-parsley-required-message="Preencha este campo" class="form-control" value="<?=$numero;?>">
	</div>
	<div class="col-12 col-md-3" >

		<label for="data">Data de Lançamento</label>
		<input type="text" name="data" id="data"
		required data-parsley-required-message="Preencha este campo" class="form-control" value="<?=$data;?>">
	</div>
	<div class="col-12 col-md-3">

		<label for="valor">Valor</label>
		<input type="text" name="valor" id="valor"
		required data-parsley-required-message="Preencha este campo" class="form-control" value="<?=$valor;?>">
	</div>
